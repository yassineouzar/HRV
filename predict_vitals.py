...
def predict_vitals(args):
    ...
    img_cols = 36
    frame_depth = 10
    model_checkpoint = 'C:/Users/ouzar1/Desktop/rPPG-heart-rate-estimation-deep-learning-method-main/codes/MTTS-CAN-Without-SNR/mtts_can.hdf5'
    batch_size = args.batch_size
    fs = args.sampling_rate
    #sample_data_path = "G:/F001_T1.mkv"
    sample_data_path = "G:/1.avi"
    ...
    #
    # sps = round(1000 / 25)
    # resample = gtData[0::sps]
    #
    # gtData2 = np.array(resample)
